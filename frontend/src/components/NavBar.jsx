...
const NavBar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        <img src={logo} alt="" className='w-34 cursor-pointer h-20' />
        ...
        <div className='flex items-center gap-4 '>
            {
                ...
                ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                    ...
                    <img className='w-3' src={drop} alt="" />
                ...
                : <button onClick={()=>navigate('/login')} className='bg-[#40E0D0] px-8 py-3 rounded-full font-light hidden md:block text-black'>Create Account</button>
            }
        </div>
    </div>
  )
