...
const TopTherapists = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
        <h1 className='text-3xl font-medium'>Top Therapists</h1> 
        ...
        <button onClick={() => { navigate('/therapists'); window.scrollTo(0, 0); }} className='bg-blue-50 text-gray-600 px-12 py-13 rounded-full mt-10'>
          more
        </button>
    </div>
  )
